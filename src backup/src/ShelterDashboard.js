...
import ShelterDeathsChart from "./ShelterDeathsChart";
...
function ShelterDashboard() {
    ...
    const [shelterDeaths, setShelterDeaths] = useState([]);
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case "deaths":
                return  <ShelterDeathsChart data={shelterDeaths} />;
            case "historical":
    ...
    return (
        <div>
            ...
            <div className="Tabs">
                ...
                <button onClick={() => setActiveTab("deaths")} className={activeTab === "deaths" ? "active" : ""}>Deaths</button>
